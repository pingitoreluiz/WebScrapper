...
from ...core.models import (
    ScraperRunRequest, ScraperRunResponse, ScraperMetrics, Store, ScraperRun
)
...
async def run_scrapers_background(stores: List[Store], headless: bool, max_pages: Optional[int] = None):
    """
    ...
    for store in stores:
        try:
            ...
            logger.error("scraper_run_failed", store=store.value, error=str(e), exc_info=True)
