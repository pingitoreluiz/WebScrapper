...
class DataExtractor:
    ...
    @staticmethod
    def extract_attribute(element, selectors: SelectorSet, attribute: str) -> Optional[str]:
        """
        ...
        for selector in selectors:
            try:
                ...
                logger.debug("attribute_extraction_failed", selector=selector, error=str(e))
                continue
        
        return None
    
    @staticmethod
    def extract_link(element, selectors: SelectorSet, base_url: str = "") -> Optional[str]:
        """
    ...
    @staticmethod
    def extract_price_from_text(text: str, pattern: Optional[str] = None) -> Optional[tuple[str, float]]:
        """
