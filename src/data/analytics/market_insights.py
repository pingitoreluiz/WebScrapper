...
class MarketInsightsAnalyzer:
    ...
    def get_brand_distribution(self) -> Dict[str, int]:
        ...
        """
        results = (
            self.db.query(Product.chip_brand, func.count(Product.id).label("count"))
    ...
    def get_manufacturer_analysis(
        self, chip_brand: Optional[ChipBrand] = None
    ) -> List[Dict]:
        """
    ...
    def get_best_value_products(
        self, chip_brand: Optional[ChipBrand] = None, limit: int = 10
    ) -> List[Dict]:
        """
    ...
    def get_market_summary(self) -> Dict:
        ...
        summary = {
            ...
            "most_common_brand": (
                max(brand_dist, key=brand_dist.get) if brand_dist else None
            ),
        }
