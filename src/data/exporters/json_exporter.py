...
class JSONExporter:
    ...
    @staticmethod
    def export(
        products: List[ProductInDB], output_path: str, pretty: bool = True
    ) -> str:
        """
    ...
    def export_with_metadata(
        products: List[ProductInDB], output_path: str, metadata: Optional[dict] = None
    ) -> str:
        """
        ...
        output = {
            "metadata": metadata
            or {"exported_at": datetime.now().isoformat(), "count": len(products)},
            "products": data,
        }
