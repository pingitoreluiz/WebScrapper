...
class TestTerabyteScraper:
    ...
    def test_build_url(self, mock_config):
        ...
        assert (
            scraper.build_url(2)
            == "https://www.terabyteshop.com.br/hardware/placas-de-video?pagina=2"
        )
...
class TestKabumScraper:
    ...
    def test_selectors(self):
        ...
        selectors = scraper.get_selectors()
        assert (
            "article" in selectors.product_card.selectors
            or "div.productCard" in selectors.product_card.selectors
        )
