...
from src.scrapers.components.product_enricher import (
    ChipBrandDetector, ManufacturerDetector, ModelExtractor, ProductEnricher
)
...
class TestManufacturerDetector:
    ...
    def test_detect_generic(self):
        ...
        assert ManufacturerDetector.detect("Placa de Vídeo RTX 4090") == "Genérica/Outra"
